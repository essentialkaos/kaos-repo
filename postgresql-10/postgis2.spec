...
Patch0:            %{realname}2-gdalfpic.patch
...
%changelog
* Wed Feb 07 2018 Anton Novojilov <andy@essentialkaos.com> - 2.4.3-0
- Updated to latest stable release

* Thu Oct 12 2017 Anton Novojilov <andy@essentialkaos.com> - 2.4.0-0
- Initial build
