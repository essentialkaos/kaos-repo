...
%define alt_priority 1450

################################################################################

Summary:            OpenJDK Runtime Environment (JDK 14)
Name:               jdk14
Epoch:              1
...
Source0:            https://github.com/AdoptOpenJDK/openjdk14-binaries/releases/download/jdk-%{jdk_major}%2B%{jdk_minor}/OpenJDK14U-jdk_x64_linux_hotspot_%{jdk_major}_%{jdk_minor}.tar.gz
Source1:            java.sh
