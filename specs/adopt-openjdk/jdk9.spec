...
%define alt_priority 950

################################################################################

Summary:            OpenJDK Runtime Environment (JDK 9)
Name:               jdk9
Epoch:              1
...
Source0:            https://github.com/AdoptOpenJDK/openjdk9-binaries/releases/download/jdk-%{jdk_major}+%{jdk_minor}/OpenJDK9U-jdk_x64_linux_hotspot_%{jdk_major}_%{jdk_minor}.tar.gz
Source1:            java.sh
