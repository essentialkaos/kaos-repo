...
Source0:            https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk%{jdk_major}-%{jdk_minor}/OpenJDK8U-jdk_x64_linux_hotspot_%{jdk_major}%{jdk_minor}.tar.gz
Source1:            java.sh
