...
Source0:            https://github.com/AdoptOpenJDK/openjdk10-binaries/releases/download/jdk-%{jdk_major}+%{jdk_minor}.1/OpenJDK10U-jre_x64_linux_hotspot_%{jdk_major}_%{jdk_minor}.tar.gz
Source1:            java.sh
