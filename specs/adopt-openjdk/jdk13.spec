...
%define alt_priority 1350

################################################################################

Summary:            OpenJDK Runtime Environment (JDK 13)
Name:               jdk13
Epoch:              1
...
Source0:            https://github.com/AdoptOpenJDK/openjdk13-binaries/releases/download/jdk-%{jdk_major}+%{jdk_minor}/OpenJDK13U-jdk_x64_linux_hotspot_%{jdk_major}_%{jdk_minor}.tar.gz
Source1:            java.sh
