...
BuildRequires:  %{python_base}-devel %{python_base}-setuptools %{python_base}-backports

Requires:       %{python_base} %{python_base}-backports
...
%changelog
* Wed Oct 23 2019 Andrey Kulikov <avk@brewkeeper.net> - 3.5.0.1-2
