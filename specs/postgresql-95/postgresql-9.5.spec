...
%{__updalt} --install %{_sharedstatedir}/%{shortname}/.bash_profile %{shortname}-bash_profile %{install_dir}/share/bash_profile %{pkgver}0
...
%{__updalt} --install %{_libdir}/pkgconfig/libpq.pc           %{shortname}-pkgconfig-libpq           %{install_dir}/lib/pkgconfig/libpq.pc          %{pkgver}0
%{__updalt} --install %{_libdir}/pkgconfig/libpgtypes.pc      %{shortname}-pkgconfig-libpgtypes      %{install_dir}/lib/pkgconfig/libpgtypes.pc     %{pkgver}0
%{__updalt} --install %{_libdir}/pkgconfig/libecpg.pc         %{shortname}-pkgconfig-libecpg         %{install_dir}/lib/pkgconfig/libecpg.pc        %{pkgver}0
%{__updalt} --install %{_libdir}/pkgconfig/libecpg_compat.pc  %{shortname}-pkgconfig-libecpg_compat  %{install_dir}/lib/pkgconfig/libecpg_compat.pc %{pkgver}0
...
%changelog
* Thu Apr 01 2021 Anton Novojilov <andy@essentialkaos.com> - 9.5.25-1
- Changed bash_profile installation routine

* Mon Feb 15 2021 Anton Novojilov <andy@essentialkaos.com> - 9.5.25-0
- Updated to the latest (final) stable release

* Tue Dec 29 2020 Anton Novojilov <andy@essentialkaos.com> - 9.5.24-0
...
* Mon Jan 20 2020 Anton Novojilov <andy@essentialkaos.com> - 9.5.20-0
- Updated to the latest stable release
...
* Tue Feb 26 2019 Anton Novojilov <andy@essentialkaos.com> - 9.5.16-0
- Updated to the latest stable release

* Sat Nov 17 2018 Anton Novojilov <andy@essentialkaos.com> - 9.5.15-0
- Updated to the latest stable release

* Wed Sep 12 2018 Anton Novojilov <andy@essentialkaos.com> - 9.5.14-0
- Updated to the latest stable release

* Tue Jun 19 2018 Anton Novojilov <andy@essentialkaos.com> - 9.5.13-0
- Updated to the latest stable release
...
* Tue May 16 2017 Anton Novojilov <andy@essentialkaos.com> - 9.5.7-0
- Updated to the latest stable release

* Wed Mar 22 2017 Anton Novojilov <andy@essentialkaos.com> - 9.5.6-0
- Updated to the latest stable release

* Sun Nov 20 2016 Anton Novojilov <andy@essentialkaos.com> - 9.5.5-0
- Updated to the latest stable release
...
* Mon Jun 27 2016 Anton Novojilov <andy@essentialkaos.com> - 9.5.3-2
- Added installing pg_config link using update-alternatives
- Added installing pg_basebackup link using update-alternatives

* Mon May 23 2016 Anton Novojilov <andy@essentialkaos.com> - 9.5.3-1
- Fixed reading locale bug on CentOS7+

* Mon May 16 2016 Anton Novojilov <andy@essentialkaos.com> - 9.5.3-0
- Updated to the latest stable release

* Thu Apr 07 2016 Anton Novojilov <andy@essentialkaos.com> - 9.5.2-0
- Updated to the latest stable release

* Wed Feb 24 2016 Anton Novojilov <andy@essentialkaos.com> - 9.5.1-0
- Updated to the latest stable release

* Sat Jan 09 2016 Anton Novojilov <andy@essentialkaos.com> - 9.5.0-0
- Initial build
