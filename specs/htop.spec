...
%changelog
* Thu Jun 25 2026 Anton Novojilov <andy@essentialkaos.com> - 3.5.1-0
...
* Thu Jun 25 2026 Anton Novojilov <andy@essentialkaos.com> - 3.5.0-0
...
- Add lost focus event, make mouse actions consistent, handle rename and move
  explicitly across screens / meters / columns
- Make Cancel (F2, Esc) remove a newly added screen tab and not only abort the
  implicit rename
- Use default key list for DisplayOptions "Dec/Inc" function bar
- Make first click select option line but not toggle it, toggle with next click,
  handle right click
...
* Wed Apr 16 2025 Anton Novojilov <andy@essentialkaos.com> - 3.4.0-0
- More expressive version tag generated for development versions
  (htop --version, help screen)
