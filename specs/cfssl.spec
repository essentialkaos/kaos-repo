...
Source:             https://github.com/cloudflare/%{name}/archive/v%{version}.tar.gz
...
%changelog
* Fri Dec 13 2019 Anton Novojilov <andy@essentialkaos.com> - 1.4.1-0
- Updated to the latest stable release

* Fri Dec 13 2019 Anton Novojilov <andy@essentialkaos.com> - 1.4.0-0
- Updated to the latest stable release
