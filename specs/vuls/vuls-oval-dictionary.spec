...
# rpmbuilder:gopack    github.com/kotakanbe/goval-dictionary
# rpmbuilder:tag       v0.1.0
...
%define service_name      ovald-server
%define short_name        oval-dictionary
...
License:         APLv2
URL:             https://github.com/kotakanbe/goval-dictionary
...
%description
This is tool to build a local copy of the OVAL. The local copy is generated in
...
sed -i "s#/var/log/vuls#%{service_logdir}#" \
       src/github.com/kotakanbe/goval-dictionary/util/util.go

go build -ldflags "$LD_FLAGS" -o %{short_name} src/github.com/kotakanbe/goval-dictionary/main.go
...
install -pDm 644 %{SOURCE2} %{buildroot}%{_sysconfdir}/sysconfig/%{service_name}
...
%changelog
* Tue Dec 11 2018 Anton Novojilov <andy@essentialkaos.com> - 0.1.0-0
