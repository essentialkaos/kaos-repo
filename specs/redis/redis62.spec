...
Conflicts:         redis redis50 redis60 redis70 redis72
...
%changelog
* Thu Oct 19 2023 Anton Novojilov <andy@essentialkaos.com> - 6.2.14-0
- https://github.com/redis/redis/blob/6.2.14/00-RELEASENOTES
