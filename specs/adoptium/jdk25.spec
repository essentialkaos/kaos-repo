...
%define alt_priority  2551

################################################################################

Summary:      OpenJDK Runtime Environment (JDK 25)
Name:         jdk25
Epoch:        1
Version:      %{jdk_major}
...
Source0:      https://github.com/adoptium/temurin25-binaries/releases/download/jdk-%{jdk_major}+%{jdk_minor}/OpenJDK25U-jdk_x64_linux_hotspot_%{jdk_major}_%{jdk_minor}.tar.gz
Source1:      java.sh
...
Conflicts:    java-25-openjdk-headless

AutoProv:     no
AutoReqProv:  no

Provides:     jdk = 1:25
Provides:     jdk-lts = 1:25
Provides:     java = 1:25
