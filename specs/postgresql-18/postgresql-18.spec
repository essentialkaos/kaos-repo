...
%if 0%{?rhel} == 8
%{!?uring:%global uring 0}
%else
%{!?uring:%global uring 1}
%endif
...
BuildRequires:     make gcc gcc-c++ glibc-devel bison flex
BuildRequires:     readline-devel zlib-devel
BuildRequires:     libxml2-devel libxslt-devel

%if %plperl
BuildRequires:     perl perl-generators perl-ExtUtils-Embed
%endif
...
%{install_dir}/lib/pg_logicalinspect.so
%{install_dir}/lib/pg_overexplain.so
...
%{install_dir}/share/extension/pg_logicalinspect*
