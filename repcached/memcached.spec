...
%define niceexit          exit 0

###############################################################################

Summary:                  High Performance, Distributed Memory Object Cache (Repcached)
Name:                     memcached
Version:                  1.4.13
Release:                  7%{?dist}
Group:                    System Environment/Daemons
License:                  BSD
URL:                      https://github.com/essentialkaos/memcached
...
%{__useradd} -r -g %{groupname} -d %{_localstatedir}/run/%{name} \
...
%changelog
* Mon May 05 2014 Anton Novojilov <andy@essentialkaos.com> - 1.4.13-7
- Rebuild
