...
%post
%{__updalt} --install %{_bindir}/psql              %{shortname}-psql           %{install_dir}/bin/psql 920
%{__updalt} --install %{_bindir}/clusterdb         %{shortname}-clusterdb      %{install_dir}/bin/clusterdb 920
%{__updalt} --install %{_bindir}/createdb          %{shortname}-createdb       %{install_dir}/bin/createdb 920
%{__updalt} --install %{_bindir}/createlang        %{shortname}-createlang     %{install_dir}/bin/createlang 920
%{__updalt} --install %{_bindir}/createuser        %{shortname}-createuser     %{install_dir}/bin/createuser 920
%{__updalt} --install %{_bindir}/dropdb            %{shortname}-dropdb         %{install_dir}/bin/dropdb 920
%{__updalt} --install %{_bindir}/droplang          %{shortname}-droplang       %{install_dir}/bin/droplang 920
%{__updalt} --install %{_bindir}/dropuser          %{shortname}-dropuser       %{install_dir}/bin/dropuser 920
%{__updalt} --install %{_bindir}/pg_dump           %{shortname}-pg_dump        %{install_dir}/bin/pg_dump 920
%{__updalt} --install %{_bindir}/pg_dumpall        %{shortname}-pg_dumpall     %{install_dir}/bin/pg_dumpall 920
%{__updalt} --install %{_bindir}/pg_restore        %{shortname}-pg_restore     %{install_dir}/bin/pg_restore 920
%{__updalt} --install %{_bindir}/reindexdb         %{shortname}-reindexdb      %{install_dir}/bin/reindexdb 920
%{__updalt} --install %{_bindir}/vacuumdb          %{shortname}-vacuumdb       %{install_dir}/bin/vacuumdb 920
%{__updalt} --install %{_mandir}/man1/clusterdb.1  %{shortname}-clusterdbman   %{install_dir}/share/man/man1/clusterdb.1 920
%{__updalt} --install %{_mandir}/man1/createdb.1   %{shortname}-createdbman    %{install_dir}/share/man/man1/createdb.1 920
%{__updalt} --install %{_mandir}/man1/createlang.1 %{shortname}-createlangman  %{install_dir}/share/man/man1/createlang.1 920
%{__updalt} --install %{_mandir}/man1/createuser.1 %{shortname}-createuserman  %{install_dir}/share/man/man1/createuser.1 920
%{__updalt} --install %{_mandir}/man1/dropdb.1     %{shortname}-dropdbman      %{install_dir}/share/man/man1/dropdb.1 920
%{__updalt} --install %{_mandir}/man1/droplang.1   %{shortname}-droplangman    %{install_dir}/share/man/man1/droplang.1 920
%{__updalt} --install %{_mandir}/man1/dropuser.1   %{shortname}-dropuserman    %{install_dir}/share/man/man1/dropuser.1 920
%{__updalt} --install %{_mandir}/man1/pg_dump.1    %{shortname}-pg_dumpman     %{install_dir}/share/man/man1/pg_dump.1 920
%{__updalt} --install %{_mandir}/man1/pg_dumpall.1 %{shortname}-pg_dumpallman  %{install_dir}/share/man/man1/pg_dumpall.1 920
%{__updalt} --install %{_mandir}/man1/pg_restore.1 %{shortname}-pg_restoreman  %{install_dir}/share/man/man1/pg_restore.1 920
%{__updalt} --install %{_mandir}/man1/psql.1       %{shortname}-psqlman        %{install_dir}/share/man/man1/psql.1 920
%{__updalt} --install %{_mandir}/man1/reindexdb.1  %{shortname}-reindexdbman   %{install_dir}/share/man/man1/reindexdb.1 920
%{__updalt} --install %{_mandir}/man1/vacuumdb.1   %{shortname}-vacuumdbman    %{install_dir}/share/man/man1/vacuumdb.1 920

%post libs
%{__updalt} --install %{_sysconfdir}/ld.so.conf.d/%{realname}-pgdg-libs.conf  %{shortname}-ld-conf  %{install_dir}/share/%{service_name}-libs.conf 930
%{__ldconfig}
...
%changelog
* Mon May 23 2016 Anton Novojilov <andy@essentialkaos.com> - 9.3.13-1
...
* Fri Nov 07 2014 Anton Novojilov <andy@essentialkaos.com> - 9.3.5-6
- Fixed bug in spec with post and postun scriptlets execution

* Tue Oct 28 2014 Anton Novojilov <andy@essentialkaos.com> - 9.3.5-5
- Init script migrated to kaosv2

* Sun Oct 05 2014 Anton Novojilov <andy@essentialkaos.com> - 9.3.5-4
- Fixed bug with database initialization in init.d script

* Tue Sep 16 2014 Anton Novojilov <andy@essentialkaos.com> - 9.3.0-0
- Initial build
